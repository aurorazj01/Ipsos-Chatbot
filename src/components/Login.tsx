...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F7FA] flex items-center justify-center p-4">
      ...
      >
        <div className="bg-ipsos-blue p-10 text-center">
          <h1 className="text-2xl font-bold text-white tracking-tight">Ipsos 专属助手</h1>
          <p className="text-white/70 text-sm mt-2">益普索内部员工登录</p>
        </div>
